...
export const Route = createFileRoute("/gutter-cleaning/toronto")({
  head: () => ({
    meta: [
      {
        title: "Gutter Cleaning Toronto | Compare Local Gutter Cleaning Quotes",
      },
      {
        name: "description",
        content:
          "Looking for gutter cleaning in Toronto? Compare quotes from local gutter cleaning companies serving North York, Scarborough, Etobicoke and the GTA.",
      },
      {
        property: "og:title",
        content: "Gutter Cleaning Toronto | Get Free Quotes",
      },
      {
        property: "og:description",
        content:
          "Find local gutter cleaning professionals in Toronto and compare free quotes.",
      },
    ],
  }),
  component: GutterCleaningTorontoPage,
});

function GutterCleaningTorontoPage() {
  return (
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-10 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 lg:pt-16">
          <div>
            ...
            <h1 className="mt-5 font-display text-5xl font-bold tracking-tight text-navy sm:text-6xl lg:text-7xl">
              Gutter Cleaning <span className="text-brand">Toronto</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-1.5">
                <Check className="h-4 w-4 text-brand" /> Local Toronto pros
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-lift">
              <img
                src="/images/gutter-cleaning-toronto-hero.png"
                alt="Professional gutter cleaning service in Toronto"
                width={1280}
                height={1280}
      ...
      <section className="bg-background py-20">
        <div className="mx-auto max-w-4xl px-5 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-wider text-brand">
            Toronto Gutter Cleaning
          </p>

          <h2 className="mt-3 font-display text-4xl font-bold text-navy">
            Gutter Cleaning Toronto: Protect Your Home Year-Round
          </h2>

          <p className="mt-6 text-lg text-muted-foreground">
            Toronto homeowners deal with heavy leaf buildup, seasonal storms,
            freezing temperatures, and spring runoff. Regular gutter cleaning helps
            keep water flowing properly and reduces the risk of water damage to your
            roof, siding, landscaping, and foundation.
          </p>

          <p className="mt-4 text-lg text-muted-foreground">
            Whether you live in North York, Scarborough, Etobicoke, East York, York,
            or Downtown Toronto, keeping your gutters clean is an important part of
      ...
      <section id="pricing" className="bg-background py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">
              Gutter cleaning cost in Toronto
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
          ...
          <div className="mt-10 space-y-8">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Most Toronto homes benefit from gutter cleaning at least twice per
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-8 space-y-3">
              {[
                ...
                "Serving Toronto and nearby GTA areas",
              ].map((t) => (
