...
export const Route = createFileRoute("/gutter-cleaning/scarborough")({
  head: () => ({
    meta: [
      {
        title: "Gutter Cleaning Scarborough | Compare Local Gutter Cleaning Quotes",
      },
      {
        name: "description",
        content:
          "Looking for gutter cleaning in Scarborough? Compare quotes from local gutter cleaning companies serving Scarborough and nearby Toronto communities."
      },
      {
        property: "og:title",
        content: "Gutter Cleaning Scarborough | Get Free Quotes",
      },
      {
        property: "og:description",
        content:
          "Find local gutter cleaning professionals in Scarborough and compare free quotes.",
      },
    ],
  }),
  component: GutterCleaningScarboroughPage,
});

function GutterCleaningScarboroughPage() {
  return (
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-10 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 lg:pt-16">
          <div>
            ...
            <h1 className="mt-5 font-display text-5xl font-bold tracking-tight text-navy sm:text-6xl lg:text-7xl">
              Gutter Cleaning <span className="text-brand">Scarborough</span>
            </h1>

            <p className="mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl">
              Compare quotes from trusted local gutter cleaning professionals serving Scarborough and surrounding Toronto neighbourhoods.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-1.5">
                <Check className="h-4 w-4 text-brand" /> Local Scarborough pros
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-lift">
              <img 
                src="/images/gutter-cleaning-scarborough-hero.png"
                alt="Professional gutter cleaning service in Scarborough"
                width={1280}
                height={1280}
      ...
      <section className="bg-background py-20">
        <div className="mx-auto max-w-4xl px-5 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-wider text-brand">
            Scarborough Gutter Cleaning
          </p>

          <h2 className="mt-3 font-display text-4xl font-bold text-navy">
            Gutter Cleaning Scarborough: Protect Your Home Year-Round
          </h2>

          <p className="mt-6 text-lg text-muted-foreground">
            Scarborough homeowners experience heavy spring runoff, autumn leaf buildup, and changing weather conditions that can clog gutters and downspouts. Regular gutter cleaning helps water drain properly and reduces the risk of roof, siding, and foundation damage.
          </p>

          <p className="mt-4 text-lg text-muted-foreground">
            Whether you live in Agincourt, Guildwood, Birch Cliff, Highland Creek, West Hill, Malvern, or Rouge, routine gutter cleaning helps protect your home from costly water damage.
          </p>
        </div>
      </section>
      ...
      <section id="pricing" className="bg-background py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">
              Gutter cleaning cost in Scarborough
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
          ...
          <div className="mt-10 space-y-8">
            <div>
              <h3 className="text-xl font-bold text-navy">
                How often should gutters be cleaned in Scarborough?
              </h3>

              <p className="mt-2 text-muted-foreground">
                Most Scarborough homes benefit from gutter cleaning at least twice per
      ...
      <section id="quote" className="bg-gradient-soft py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-5 lg:px-8">
          <div className="lg:col-span-2">
            ...
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">
              Get Free Scarborough Gutter Cleaning Quotes
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Fill out the form and we’ll match your request with local gutter cleaning professionals serving Scarborough. Free, fast, and no obligation.
            </p>
            ...
            <ul className="mt-8 space-y-3">
              {[
                ...
                "Serving Scarborough and surrounding Toronto neighbourhoods",
              ].map((t) => (
