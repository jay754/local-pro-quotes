...
import { ArrowRight, Check, Clock, ShieldCheck, DollarSign, Zap, FileText } from "lucide-react";
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-10 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 lg:pt-16">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground sm:text-xl">
              Tell us what you need and we'll connect you with local professionals.
            </p>
            ...
            <div className="mt-8 flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1.5"><Check className="h-4 w-4 text-brand" /> Fast responses</div>
            </div>
          </div>

          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-lift">
              <img src={heroImg} alt="Homeowner getting help on phone outside their house" width={1280} height={1280} className="aspect-square w-full object-cover sm:aspect-[4/5]" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              ...
              { n: "03", title: "Get Pricing & Availability", desc: "Get pricing and availability from trusted providers." },
            ].map((s) => (
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              { i: Zap, t: "Fast Responses", d: "Hear back quickly." },
              { i: ShieldCheck, t: "Trusted Providers", d: "We work with local pros." },
              { i: DollarSign, t: "Free To Use", d: "No cost to use our service." },
      ...
      <section id="quote" className="bg-gradient-soft py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-5 lg:px-8">
          <div className="lg:col-span-2">
            <p className="text-sm font-semibold uppercase tracking-wider text-brand">Find your pro</p>
            <h2 className="mt-3 font-display text-4xl font-bold text-navy sm:text-5xl">Find Your Pro</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Fill out the form and we'll match you with local professionals. Free, fast, and no obligation.
            </p>
            <ul className="mt-8 space-y-3">
              {["Takes under 60 seconds", "Compare responses side by side", "Only vetted local providers"].map((t) => (
