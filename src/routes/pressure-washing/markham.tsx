...
export const Route = createFileRoute("/pressure-washing/markham")({
  head: () => ({
    meta: [
      {
        title:
          "Pressure Washing Markham | Get Free Quotes | Get Home Quotes",
      },
      {
        name: "description",
        content:
          "Compare free pressure washing quotes in Markham for driveways, patios, decks, siding, walkways, and commercial properties.",
      },
      {
        property: "og:title",
        content: "Pressure Washing Markham | Get Free Quotes",
      },
      {
        property: "og:description",
        content:
          "Request pressure washing quotes in Markham from local professionals.",
      },
    ],
  }),
  component: MarkhamPressureWashingPage,
});

function MarkhamPressureWashingPage() {
  return (
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-white">
        <div className="mx-auto grid w-[92%] max-w-6xl gap-12 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <p className="mb-4 text-sm font-black uppercase tracking-[0.25em] text-sky-200">
              Markham Pressure Washing
            </p>

            <h1 className="mb-6 max-w-4xl text-4xl font-black leading-tight md:text-6xl">
              Pressure washing services in Markham for cleaner outdoor spaces.
            </h1>
            ...
            <p className="mb-8 max-w-2xl text-lg leading-8 text-sky-100">
              ...
              exterior surfaces across Markham.
            </p>
        ...
        <div className="mx-auto w-[92%] max-w-6xl">
            ...
            <h2 className="mb-5 text-4xl font-black text-navy md:text-5xl">
                Request pressure washing quotes in Markham.
            </h2>
            ...
            <div className="rounded-3xl border bg-white p-8 shadow-card transition hover:-translate-y-1 hover:shadow-lift">
                ...
                <p className="text-muted-foreground">
                Serving homeowners and businesses across Markham and surrounding
                neighbourhoods.
                </p>
            </div>
        ...
        <div className="mx-auto w-[92%] max-w-6xl">
            ...
            <h2 className="mb-5 text-4xl font-black text-navy md:text-5xl">
                Pressure washing services across Markham.
            </h2>

            <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
                Looking for pressure washing near you? Request quotes from local providers
                serving neighbourhoods across Markham.
            </p>
        ...
        <div className="mx-auto w-[92%] max-w-4xl">
            ...
            {[
                {
                question: "How much does pressure washing cost in Markham?",
                answer:
